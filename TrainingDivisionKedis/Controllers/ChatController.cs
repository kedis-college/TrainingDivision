...
namespace TrainingDivisionKedis.Controllers
{
    ...
    public class ChatController : Controller
    {
        ...
        public ChatController(IChatService<SPStudentsGetWithSpeciality> chatService)
        {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            if (response.Succedeed)
            {
                ...
                return View(new List<SPStudentsGetWithSpeciality>()).WithDanger("Ошибка!", response.Error.Message);
        }
